...
### INSTALACIÓN
El código se encarga de instalar automáticamente algunas librerías poco comunes en caso de que el usuario no las tenga. Las librerías en cuestión son Tensorflow, Pillow y Pygame.
