...
THETA_PLOT_SPECS = [
    ('left', -180.0, -120.0),
    ('tri', -130.0, -100.0, -70.0),
    ('tri', -80.0, -50.0, -20.0),
    ('tri', -30.0, 0.0, 30.0),
    ('tri', 20.0, 50.0, 80.0),
    ('tri', 70.0, 100.0, 130.0),
    ('right', 120.0, 180.0),
]
...
F_PLOT_SPECS = [
    ('left', -300.0, -240.0),
    ('tri', -260.0, -200.0, -140.0),
    ('tri', -160.0, -100.0, -40.0),
    ('tri', -60.0,    0.0,  60.0),
    ('tri',  40.0,  100.0, 160.0),
    ('tri',  140.0,  200.0, 260.0),
    ('right', 240.0, 300.0),
]
...
THETA_CTRL_SPECS = [
    ('left', -130.0, -110.0),
    ('tri', -160.0, -110.0, -60.0),
    ('tri', -100.0, -50.0, 0.0),
    ('tri', -50.0, 0.0, 50.0),
    ('tri', 0.0, 50.0, 100.0),
    ('tri', 60.0, 110.0, 160.0),
    ('right', 110.0, 130.0),
]
...
def simular(delta_t=0.005, theta_0_deg=170.0, v_0_deg=0.0):
    ...
    def update(_):
        ...
        _last_wall[0] = now
        sim_time = min(elapsed_wall * VELOCIDAD, delta_t * 10)
...
if __name__ == '__main__':
    ...
    simular(delta_t=0.005, theta_0_deg=170.0, v_0_deg=0.0)
